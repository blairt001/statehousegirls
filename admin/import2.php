		 ...
		 if($_FILES["file"]["size"] > 0)
		 {
	         ...
	         while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
	         {
	          ...
	          //It wiil insert a row to our subject table from our csv file`
	           $sql = "INSERT INTO term2(Class, AdmnNo, StudentName, EntryMark, MATH, KISW, ENG, HIST, IRE, CRE, GEO, AGRIC, ART, COMP, HSE, GER, FRE, BUS, MUS, PHY, BIO, CHEM, TOTAL, Average, Grade, Mscore, StreamPstn, FormPst, TargetedGrade, TargetedMScore) VALUES  
