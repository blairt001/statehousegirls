...
a.link:hover
{
	...
	<div align="right" class="navlinks">
			<ul>
			<li><a href="index3.php" class="link">Back Home</a></li>
			</ul>
		</div>
	<br />
	<br />
	<br />
	<center><h1><font color="orange"><i>Enter the password for accessing the assignments. If you dont have the password, consult the school administrator:</i></font></h1></center>
	<br />
	<br />
	<br />
	<br />
	<center><form method="POST" action="bdocs3.php">
	          <fieldset>
