...
<div align="center" class="navlinks">
			<ul>
			<li><a href="index.php" class="link"><font size="3px;"><font color="black"><b>Home</b></font></font></a></li>
			&nbsp;
			&nbsp;
			&nbsp;
			&nbsp;
...
<?php echo '<marquee><h3><font color="white"><font size="10px;">Welcome Back <font color="green">'. $_COOKIE['StudentName']."</font></font></font></h3></marquee>";?> 
<center><h1><font color="green"><u>Your Details</u></font></h1><?php
echo '<h3><font color="blue">Your Name:</font>'. $_COOKIE['StudentName']."</h3>"; 
echo  '<h3><font color="blue">Your Admno / Index No:</font>'.$_COOKIE['AdmnNo'].'</h3>';
echo '<h3><font color="blue">Your Class:</font>'. $_COOKIE['Class']."</h3>"; 
echo  '<h3><font color="blue">Your Entry Marks:</font>'.$_COOKIE['EntryMark'].'</h3>';
echo  '<h3><font color="blue">Current Year: <font color="black">2018</font></font></h3>';
